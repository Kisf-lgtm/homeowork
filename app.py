...
""")
    ...
    # ✨ 核心修改点 1：修正图表5的文字说明，使其与柱状图数据完全吻合
...
- **办公模式**：无远程岗位与全远程岗位的平均薪资整体维持在较高水平（均超13万美元），而混合办公岗位（50%）的薪资水平则表现出明显劣势。这表明完全集中办公或完全远程成熟度更高的企业往往愿意支付更高的薪水。
""")
